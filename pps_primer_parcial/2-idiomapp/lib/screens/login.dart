...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _buildTestUserButton(
      String email, String password, String label, IconData icon, Color color) {
    return Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: Colors.blue[100]!, blurRadius: 12)
                  ],
                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 12),
                    Text(
                      '¡Hola! Ingresa para jugar y aprender',
                      style: TextStyle(
                        fontSize: 22,
                    ...
                    Wrap(
                      ...
                      children: [
                        _buildTestUserButton('admin@admin.com', '111111',
                            'Admin', Icons.star, Colors.orange),
                        _buildTestUserButton('invitado@invitado.com', '222222',
                            'Invitado', Icons.face, Colors.green),
                        _buildTestUserButton('usuario@usuario.com', '333333',
                            'Usuario', Icons.child_care, Colors.blue),
                        _buildTestUserButton('anonimo@anonimo.com', '444444',
                            'Anónimo', Icons.visibility_off, Colors.grey),
                        _buildTestUserButton('tester@tester.com', '555555',
                            'Tester', Icons.bug_report, Colors.purple),
                      ],
                    ),
                  ],
                ),
